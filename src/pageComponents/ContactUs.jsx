...
const ContactUs = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (validate()) {
      ...
      axios
        .post(links.backendUrl + "/contact-us", contactData)
        .then((res) => {
          dispatch(endLoader());
        ...
        <Grid item xs={12} md={8} sx={{ mt: 4 }}>
          ...
          <Accordion>
            <AccordionSummary expandIcon={<ExpandMoreIcon />}>
              <Typography>
                How can I get in touch with a staff member?
              </Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
                There are different ways to get in touch with our staff members.
                You can either send us an query using contact form below. You
                can also chat with our live agent by pressing the blue chat
                button at the bottom right of the screen. If you are in hurry
                and want to leave a WhatsApp message, press the green WhatsApp
          ...
          <Accordion>
            ...
            <AccordionDetails>
              <Typography>
                If you want to get in contact with our live agent for any query
                please press the blue chat button at the bottom right of the
                screen. Just provide your name and email to get the conversation
                started.{" "}
              </Typography>
            </AccordionDetails>
          </Accordion>
          ...
          <Accordion>
            ...
            <AccordionDetails>
              <Typography>
                We are loacated at 44 Pirie St, Adelaide 5000. Come pay us a
                visit and know more about us!{" "}
              </Typography>
